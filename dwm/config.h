...
static const char col_gray[]        = "#1d2021";
static const char col_sel[]         = "#98971a";
static const char *colors[][3]      = {
	/*                    fg         bg         border   */
	[SchemeNorm]     = { col_fg, col_bg, col_gray },
	[SchemeSel]      = { col_gray, col_sel,  col_sel  },
	[SchemeStatus]   = { col_fg, "#458588",  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { col_gray, col_sel,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg, "-nf", col_fg, "-sb", col_sel, "-sf", col_gray, NULL };
